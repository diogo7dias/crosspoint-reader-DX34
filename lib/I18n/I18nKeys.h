...
enum class StrId : uint16_t {
  ...
  STR_BLUETOOTH_HID,
  STR_BLE_SCANNING,
  STR_BLE_INITIALIZING,
  STR_BLE_NO_DEVICES,
  STR_BLE_CONNECTING,
  STR_BLE_CONNECTED,
  STR_BLE_CONNECT_FAILED,
  STR_BLE_SCAN_HINT,
  STR_BLE_UNPAIR,
  STR_BLE_UNPAIR_CONFIRM,
  STR_BLE_REMAP_TITLE,
  STR_BLE_REMAP_PROMPT,
  STR_BLE_KEY_UNASSIGNED,
  STR_BLE_REMAP_RESET_HINT,
  STR_BLE_REMAP_CANCEL_HINT,
