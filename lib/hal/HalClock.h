...
// DS3231 real-time-clock HAL (X3 only). The X3 carries a battery-backed DS3231
// on the shared I2C bus; the X4 has no RTC, so begin() leaves _available=false
// and every accessor short-circuits. App code gates clock UI on isAvailable().
class HalClock {
