...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> kCached = [] {
    ...
    s.push_back(SettingInfo::Toggle(StrId::STR_SHOW_SLEEP_FAVORITE_BADGE, &CrossPointSettings::showSleepFavoriteBadge,
    ...
    s.push_back(SettingInfo::Enum(StrId::STR_REFRESH_FREQ, &CrossPointSettings::refreshFrequency,
