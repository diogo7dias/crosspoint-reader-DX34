...
inline std::vector<SettingInfo> getSettingsList() {
  ...
  s.push_back(SettingInfo::Enum(
      ...
      {StrId::STR_DARK, StrId::STR_LIGHT, StrId::STR_CUSTOM, StrId::STR_COVER, StrId::STR_NONE_OPT,
       StrId::STR_COVER_CUSTOM, StrId::STR_QUOTES_WALLPAPER, StrId::STR_QUOTES_CUSTOM, StrId::STR_FREEZE},
  ...
  s.push_back(SettingInfo::Enum(StrId::STR_UI_LANGUAGE, &CrossPointSettings::uiLanguage, {}, "uiLanguage",
                                StrId::STR_CAT_DISPLAY));
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_UNIFORM_MARGINS, &CrossPointSettings::uniformMargins, "uniformMargins",
                                  StrId::STR_CAT_READER));
  ...
  s.push_back(SettingInfo::Value(StrId::STR_SCREEN_MARGIN_HORIZONTAL, &CrossPointSettings::screenMarginHorizontal,
                                 {0, 55, 5}, "screenMarginHorizontal", StrId::STR_CAT_READER));
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_HYPHENATION, &CrossPointSettings::hyphenationEnabled, "hyphenationEnabled",
                                  StrId::STR_CAT_READER));
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BATTERY, &CrossPointSettings::statusBarShowBattery,
                                  "statusBarShowBattery", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_CHAPTER_PERCENT,
                                  &CrossPointSettings::statusBarShowChapterPercentage, "statusBarShowChapterPercentage",
                                  StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BOOK_BAR, &CrossPointSettings::statusBarShowBookBar,
                                  "statusBarShowBookBar", StrId::STR_STATUS_BAR));
  ...
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_CHAPTER_BAR_POSITION,
                                &CrossPointSettings::statusBarChapterBarPosition,
                                {StrId::STR_STATUS_POSITION_TOP, StrId::STR_STATUS_POSITION_BOTTOM},
  ...
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_FONT_SIZE, &CrossPointSettings::statusBarFontSize,
                                {StrId::STR_STATUS_FONT_MIN, StrId::STR_STATUS_FONT_MAX}, "statusBarFontSize",
                                StrId::STR_STATUS_BAR));
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_LONG_PRESS_SKIP, &CrossPointSettings::longPressChapterSkip,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_RANDOM_BOOK_ON_BOOT, &CrossPointSettings::randomBookOnBoot,
                                  "randomBookOnBoot", StrId::STR_CAT_SYSTEM));
  s.push_back(SettingInfo::Enum(StrId::STR_BOOKS_FOLDER_ORDER, &CrossPointSettings::booksFolderOrder,
                                {StrId::STR_BOOKS_ORDER_ABC, StrId::STR_BOOKS_ORDER_RANDOM}, "booksFolderOrder",
                                StrId::STR_CAT_SYSTEM));
