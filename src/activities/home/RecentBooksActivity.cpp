...
void RecentBooksActivity::loop() {
  const int pageItems = BaseTheme::getNumberOfItemsPerPage(renderer, true, false, true, true);
...
void RecentBooksActivity::render(Activity::RenderLock&&) {
  ...
  if (recentBooks.empty()) {
    ...
    GUI.drawList(
        ...
        [this](int index) { return recentBooks[index].title; }, [](int) { return std::string(); }, nullptr, nullptr);
  }
