...
class ReaderActivity final : public ActivityWithSubactivity {
 ...
 public:
  // Static: pure path→Epub loader (Storage + settings only, no activity
  // state). Also used by EpubReaderActivity to reload the book it released
  // for the KOReader-sync TLS window.
 ...
 protected:
  // Override: when an inner reader subactivity (Epub/Txt/Quotes) cannot
