...
- Step 2 (next) — OOM fuzz harness: drive real pipelines on host under scripted Nth-allocation failure, assert no-abort + graceful-degrade + recovery, lock in `pio test`.
